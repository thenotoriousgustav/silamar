          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              ...
              <select
                {...register("tone")}
                id="select-tone"
                className="w-full rounded-xl border border-white/10 bg-surface-800 px-4 py-3 text-sm text-white outline-none focus:border-brand-500"
              >
          ...
          {result && (
            <>
              <div className="glass rounded-2xl p-6">
                ...
                <p className="rounded-lg bg-surface-800 px-4 py-2.5 text-sm text-white font-medium">
                  {result.subject}
                </p>
              </div>
              ...
              <div className="glass rounded-2xl p-6">
                <div className="mb-3 flex items-center justify-between">
                  ...
                  <button
                    onClick={handleCopy}
                    className="flex items-center gap-1.5 rounded-lg bg-surface-800 px-3 py-1.5 text-xs font-medium text-surface-300 hover:text-white transition-colors"
                  >
                    {copied ? (
                ...
                <div className="rounded-xl bg-surface-800 p-4 text-sm text-surface-200 leading-relaxed whitespace-pre-wrap">
                  {result.coverLetter}
                </div>
              </div>
