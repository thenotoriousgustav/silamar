...
import { updateCoverLetterAction, createCoverLetterAction } from "@/server/actions/documents/cover-letters";
import { CoverLetterBuilderData } from "@/app/(dashboard)/documents/cover-letter/components/schema";
...
export function useCoverLetterBuilder(
  ...
  const updateContent = useCallback((update: Partial<CoverLetterBuilderData>) => {
