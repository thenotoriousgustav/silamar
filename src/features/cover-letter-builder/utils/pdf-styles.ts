 ...
 */
export function resolveCoverLetterPdfStyle(style?: CoverLetterBuilderData["style"]) {
  ...
  return { fontSize, lineHeight, fontFamily, paperSize, uppercaseHeaders, language };
}
