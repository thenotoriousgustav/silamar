...
import { PAGE_HEIGHT, PAGE_PADDING_X, PAGE_PADDING_Y, PAGE_WIDTH } from "./pagination-engine";
 ...
 */
export const A4Page = memo(function A4Page({ children, className }: A4PageProps) {
  return (
    <div
      className={cn(
        "relative shrink-0 bg-white shadow-2xl",
        className,
      )}
      style={{
        width: PAGE_WIDTH,
